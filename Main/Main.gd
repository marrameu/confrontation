			...
			if Network.match_data.recived:
				...
				if not _capital_ships_instantiated:
					for capital_ship_data in capital_ships_data:
						_add_new_frigate(capital_ship_data)
